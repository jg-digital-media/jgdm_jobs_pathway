    ...
    <tbody>
        ...
        <tr>
            <td colspan="2" id="job---personal--notes">
                ...
                <textarea class="edit-mode job-edit-input" style="display: none; width: 100%; min-height: 150px; padding: 10px;" data-field="description"><?php echo esc_attr($description); ?></textarea>
            </td>
        </tr>
